...
'''
Source of this code: https://github.com/ReyhaneAskari/pytorch_experiments/blob/master/VAE.py

We can use this a framework. We need to implement PixelCNN here, and explicitly define
the likelihood (decoder). We also need to explicitly define the quantization mechanism.
'''
...
class VariationalAutoencoder(nn.Module):
    ...
    def quantize(self, encoded_image):
        '''
        This function quantizes the encoded image.
        '''
